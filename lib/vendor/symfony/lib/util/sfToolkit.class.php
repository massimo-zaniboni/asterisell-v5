...
class sfToolkit
{
  ...
  public static function pregtr($search, $replacePairs)
  {
     ...
     *
     * @param mixed $search        subject to search
     * @param array $replacePairs  array of search => call back functions
     */
    public static function pregtr_callback($search, $replacePairs)
    {
        // Massimo Zaniboni: added for supporting preg_replace_callback

        foreach($replacePairs as $pattern => $callback) {
            $search = preg_replace_callback($pattern, $callback, $search);
        }
