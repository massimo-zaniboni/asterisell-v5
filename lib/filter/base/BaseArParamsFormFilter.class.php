...
abstract class BaseArParamsFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'new_imported_cdrs_to_calldate'                             => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      ...
      'scheduled_rerate_to_specific_calldate'                     => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'scheduled_imported_services_rerate_from_specific_calldate' => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'scheduled_imported_services_rerate_to_specific_calldate'   => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->setValidators(array(
      ...
      'new_imported_cdrs_to_calldate'                             => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
      ...
      'scheduled_rerate_to_specific_calldate'                     => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
      'scheduled_imported_services_rerate_from_specific_calldate' => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
      'scheduled_imported_services_rerate_to_specific_calldate'   => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
  ...
  public function getFields()
  {
    return array(
      ...
      'new_imported_cdrs_to_calldate'                             => 'Date',
      'scheduled_rerate_from_specific_calldate'                   => 'Date',
      'scheduled_rerate_to_specific_calldate'                     => 'Date',
      'scheduled_imported_services_rerate_from_specific_calldate' => 'Date',
      'scheduled_imported_services_rerate_to_specific_calldate'   => 'Date',
