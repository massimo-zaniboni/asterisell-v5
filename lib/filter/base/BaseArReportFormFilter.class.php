...
abstract class BaseArReportFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'total_without_tax'                           => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'about_ar_report_set_id'                      => new sfValidatorPropelChoice(array('required' => false, 'model' => 'ArReportSet', 'column' => 'id')),
      ...
      'ar_tag_id'                                   => new sfValidatorPropelChoice(array('required' => false, 'model' => 'ArTag', 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'about_ar_report_set_id'                      => 'ForeignKey',
