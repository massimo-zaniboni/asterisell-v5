...
abstract class BaseArReportForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'produced_report_short_description'           => new sfValidatorString(array('max_length' => 512, 'required' => false)),
      'produced_report_additional_description'      => new sfValidatorString(array('max_length' => 1024, 'required' => false)),
      ...
      'report_mail_subject'                         => new sfValidatorString(array('max_length' => 512, 'required' => false)),
      'report_mail_body'                            => new sfValidatorString(array('max_length' => 2048, 'required' => false)),
      ...
      'legal_nr_prefix'                             => new sfValidatorString(array('max_length' => 80)),
      ...
      'total_without_tax'                           => new sfValidatorInteger(array('min' => -9.2233720368548E+18, 'max' => 9223372036854775807)),
