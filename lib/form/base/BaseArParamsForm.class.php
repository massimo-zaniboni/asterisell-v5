...
abstract class BaseArParamsForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'invoice_payment_due_in_xx_days'                  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'invoice_payment_due_in_xx_days'                  => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647, 'required' => false)),
