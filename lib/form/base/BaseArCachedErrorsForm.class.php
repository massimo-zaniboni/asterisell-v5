...
/**
 * ArCachedErrors form base class.
 *
 * @method ArCachedErrors getObject() Returns the current form's model object
 *
 * @package    asterisell
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseArCachedErrorsForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_cached_errors[%s]');
