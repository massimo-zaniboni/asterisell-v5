...
/**
 * ArTestCachedGroupedCdr form base class.
 *
 * @method ArTestCachedGroupedCdr getObject() Returns the current form's model object
 *
 * @package    asterisell
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseArTestCachedGroupedCdrForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ar_test_cached_grouped_cdr[%s]');
