...
/**
 * ArCurrentProblem form base class.
 *
 * @method ArCurrentProblem getObject() Returns the current form's model object
 *
 * @package    asterisell
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseArCurrentProblemForm extends BaseFormPropel
{
