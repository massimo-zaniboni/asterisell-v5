...
class ArOrganizationUnitHasStructureForm extends BaseArOrganizationUnitHasStructureForm
{
  ...
  public function configure()
  {
      ...
      $this->widgetSchema->setHelps(array(
          ...
          'extension_codes' => __('Unique internal extension codes, used in the CDRs for identifying this extension. Extension codes can be separated by comma ",", for example "1212,1222,1244". "123X" matches the telephone number "123" followed by one character. "123XX" matches telephone numbers starting with "123" followed by two characters. "123*" match "123" followed by zero or more characters. "X" and "*" used in the middle of an extension are considered normal chars, so "1X2*3" match the exact literal, "1X*" matches "1X" followed by zero or more chars. "1*X" matches "1*" followed by any char, "AB**" matches "AB*" followed by zero or more chars. "123" has more priority respect the pattern "12X" and "12*". "12X" has more priority respect "12*".'),
