...
/**
 * This class defines the structure of the 'ar_test_cached_grouped_cdr' table.
 *
 *
 *
 ...
 */
class ArTestCachedGroupedCdrTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ArTestCachedGroupedCdrTableMap';
	...
	{
	  // attributes
		$this->setName('ar_test_cached_grouped_cdr');
		$this->setPhpName('ArTestCachedGroupedCdr');
		$this->setClassname('ArTestCachedGroupedCdr');
...
} // ArTestCachedGroupedCdrTableMap
