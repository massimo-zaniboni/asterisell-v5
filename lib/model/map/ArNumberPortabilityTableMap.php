...
/**
 * This class defines the structure of the 'ar_number_portability' table.
 *
 *
 *
 ...
 */
class ArNumberPortabilityTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ArNumberPortabilityTableMap';
	...
	{
	  // attributes
		$this->setName('ar_number_portability');
