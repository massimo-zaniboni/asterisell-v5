...
/**
 * This class defines the structure of the 'ar_new_problem' table.
 *
 *
 *
 ...
 */
class ArNewProblemTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ArNewProblemTableMap';
	...
	{
	  // attributes
		$this->setName('ar_new_problem');
		$this->setPhpName('ArNewProblem');
		$this->setClassname('ArNewProblem');
