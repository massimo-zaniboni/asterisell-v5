...
/**
 * This class defines the structure of the 'ar_role_has_permission' table.
 *
 *
 *
 ...
 */
class ArRoleHasPermissionTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ArRoleHasPermissionTableMap';
	...
	{
	  // attributes
		$this->setName('ar_role_has_permission');
		$this->setPhpName('ArRoleHasPermission');
		$this->setClassname('ArRoleHasPermission');
