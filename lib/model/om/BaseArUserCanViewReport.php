...
/**
 * Base class that represents a row from the 'ar_user_can_view_report' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArUserCanViewReport extends BaseObject  implements Persistent {
	...
	const PEER = 'ArUserCanViewReportPeer';
	 ...
	 * @return     ArUserCanViewReport The current object (for fluent API support)
	 */
	public function setArUserId($v)
	{
		...
		if ($this->ar_user_id !== $v) {
			$this->ar_user_id = $v;
			$this->modifiedColumns[] = ArUserCanViewReportPeer::AR_USER_ID;
		}
	...
	public function setArReportId($v)
	{
		...
		if ($this->ar_report_id !== $v) {
			$this->ar_report_id = $v;
			$this->modifiedColumns[] = ArUserCanViewReportPeer::AR_REPORT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ArUserCanViewReportPeer::NUM_COLUMNS - ArUserCanViewReportPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArUserCanViewReport object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArUserCanViewReportPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArUserCanViewReportPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArUserCanViewReportPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArUserCanViewReportPeer::doInsert($this, $con);
					...
					$affectedRows += ArUserCanViewReportPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArUserCanViewReportPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArUserCanViewReportPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArUserCanViewReportPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArUserCanViewReportPeer::AR_USER_ID)) $criteria->add(ArUserCanViewReportPeer::AR_USER_ID, $this->ar_user_id);
		if ($this->isColumnModified(ArUserCanViewReportPeer::AR_REPORT_ID)) $criteria->add(ArUserCanViewReportPeer::AR_REPORT_ID, $this->ar_report_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArUserCanViewReportPeer::AR_USER_ID, $this->ar_user_id);
		$criteria->add(ArUserCanViewReportPeer::AR_REPORT_ID, $this->ar_report_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArUserCanViewReport (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArUserCanViewReport Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArUserCanViewReportPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArUserCanViewReportPeer();
		}
		return self::$peer;
	}
	...
	public function getArUser(PropelPDO $con = null)
	{
		if ($this->aArUser === null && ($this->ar_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArUser->addArUserCanViewReports($this);
			 */
		}
		return $this->aArUser;
	}
	...
	public function getArReport(PropelPDO $con = null)
	{
		if ($this->aArReport === null && ($this->ar_report_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aArReport->addArUserCanViewReports($this);
			 */
		}
