...
/**
 * Base class that represents a row from the 'ar_telephone_prefix' table.
 *
 * 
 *
...
abstract class BaseArTelephonePrefix extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the match_only_numbers_with_n_digits field.
	 * @var        int
	 */
	protected $match_only_numbers_with_n_digits;
	...
	/**
	 * The value for the display_priority_level field.
	...
	const PEER = 'ArTelephonePrefixPeer';
	...
	/**
	 * Initializes internal state of BaseArTelephonePrefix object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [match_only_numbers_with_n_digits] column value.
	 * 
	 * @return     int
	 */
	public function getMatchOnlyNumbersWithNDigits()
	{
		return $this->match_only_numbers_with_n_digits;
	}
	...
	/**
	 * Get the [display_priority_level] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [match_only_numbers_with_n_digits] column.
	 * 
	 * @param      int $v new value
	 * @return     ArTelephonePrefix The current object (for fluent API support)
	 */
	public function setMatchOnlyNumbersWithNDigits($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->match_only_numbers_with_n_digits !== $v) {
			$this->match_only_numbers_with_n_digits = $v;
			$this->modifiedColumns[] = ArTelephonePrefixPeer::MATCH_ONLY_NUMBERS_WITH_N_DIGITS;
		}

		return $this;
	} // setMatchOnlyNumbersWithNDigits()
	...
	/**
	 * Set the value of [display_priority_level] column.
	 * 
	 * @param      int $v new value
	 * @return     ArTelephonePrefix The current object (for fluent API support)
	 */
	public function setDisplayPriorityLevel($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->display_priority_level !== $v || $this->isNew()) {
			$this->display_priority_level = $v;
			$this->modifiedColumns[] = ArTelephonePrefixPeer::DISPLAY_PRIORITY_LEVEL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->prefix = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->match_only_numbers_with_n_digits = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArTelephonePrefixPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArTelephonePrefixPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getMatchOnlyNumbersWithNDigits();
				break;
			case 3:
				return $this->getName();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getMatchOnlyNumbersWithNDigits(),
			$keys[3] => $this->getName(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setMatchOnlyNumbersWithNDigits($value);
				break;
			case 3:
				$this->setName($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setMatchOnlyNumbersWithNDigits($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArTelephonePrefixPeer::MATCH_ONLY_NUMBERS_WITH_N_DIGITS)) $criteria->add(ArTelephonePrefixPeer::MATCH_ONLY_NUMBERS_WITH_N_DIGITS, $this->match_only_numbers_with_n_digits);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArTelephonePrefix (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMatchOnlyNumbersWithNDigits($this->match_only_numbers_with_n_digits);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArTelephonePrefix Clone of current object.
	 * @throws     PropelException
	 */
