...
/**
 * Base class that represents a row from the 'ar_number_portability' table.
 *
 * 
 *
...
abstract class BaseArNumberPortability extends BaseObject  implements Persistent {
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArNumberPortabilityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArNumberPortabilityPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArNumberPortability (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArNumberPortability Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArNumberPortabilityPeer
	 */
