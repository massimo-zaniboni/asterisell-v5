...
/**
 * Base class that represents a row from the 'ar_test_cached_grouped_cdr' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArTestCachedGroupedCdr extends BaseObject  implements Persistent {
	 ...
	 * @var        ArTestCachedGroupedCdrPeer
	 */
	...
	const PEER = 'ArTestCachedGroupedCdrPeer';
	...
	/**
	 * Initializes internal state of BaseArTestCachedGroupedCdr object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ArTestCachedGroupedCdr The current object (for fluent API support)
	 */
	public function setCachedParentIdHierarchy($v)
	{
		...
		$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::CACHED_PARENT_ID_HIERARCHY;
	...
	public function setBillableArOrganizationUnitId($v)
	{
		...
		if ($this->billable_ar_organization_unit_id !== $v) {
			...
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::BILLABLE_AR_ORGANIZATION_UNIT_ID;
		}
	...
	public function setCalldate($v)
	{
		...
		if ( $this->calldate !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::CALLDATE;
			}
	...
	public function setDestinationType($v)
	{
		...
		if ($this->destination_type !== $v) {
			...
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::DESTINATION_TYPE;
		}
	...
	public function setArCommunicationChannelTypeId($v)
	{
		...
		if ($this->ar_communication_channel_type_id !== $v) {
			...
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::AR_COMMUNICATION_CHANNEL_TYPE_ID;
		}
	...
	public function setOperatorType($v)
	{
		...
		if ($this->operator_type !== $v) {
			...
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::OPERATOR_TYPE;
		}
	...
	public function setArVendorId($v)
	{
		...
		if ($this->ar_vendor_id !== $v) {
			$this->ar_vendor_id = $v;
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::AR_VENDOR_ID;
		}
	...
	public function setGeographicLocation($v)
	{
		...
		if ($this->geographic_location !== $v) {
			...
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::GEOGRAPHIC_LOCATION;
		}
	...
	public function setCountOfCalls($v)
	{
		...
		if ($this->count_of_calls !== $v) {
			...
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::COUNT_OF_CALLS;
		}
	...
	public function setBillsec($v)
	{
		...
		if ($this->billsec !== $v) {
			$this->billsec = $v;
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::BILLSEC;
		}
	...
	public function setIncome($v)
	{
		...
		if ($this->income !== $v) {
			$this->income = $v;
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::INCOME;
		}
	...
	public function setCostSaving($v)
	{
		...
		if ($this->cost_saving !== $v) {
			$this->cost_saving = $v;
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::COST_SAVING;
		}
	...
	public function setCost($v)
	{
		...
		if ($this->cost !== $v) {
			$this->cost = $v;
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::COST;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v || $this->isNew()) {
			$this->id = $v;
			$this->modifiedColumns[] = ArTestCachedGroupedCdrPeer::ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = ArTestCachedGroupedCdrPeer::NUM_COLUMNS - ArTestCachedGroupedCdrPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArTestCachedGroupedCdr object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArTestCachedGroupedCdrPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArTestCachedGroupedCdrPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArTestCachedGroupedCdrPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArTestCachedGroupedCdrPeer::doInsert($this, $con);
					...
					$affectedRows += ArTestCachedGroupedCdrPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArTestCachedGroupedCdrPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArTestCachedGroupedCdrPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArTestCachedGroupedCdrPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::CACHED_PARENT_ID_HIERARCHY)) $criteria->add(ArTestCachedGroupedCdrPeer::CACHED_PARENT_ID_HIERARCHY, $this->cached_parent_id_hierarchy);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::BILLABLE_AR_ORGANIZATION_UNIT_ID)) $criteria->add(ArTestCachedGroupedCdrPeer::BILLABLE_AR_ORGANIZATION_UNIT_ID, $this->billable_ar_organization_unit_id);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::CALLDATE)) $criteria->add(ArTestCachedGroupedCdrPeer::CALLDATE, $this->calldate);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::DESTINATION_TYPE)) $criteria->add(ArTestCachedGroupedCdrPeer::DESTINATION_TYPE, $this->destination_type);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::AR_COMMUNICATION_CHANNEL_TYPE_ID)) $criteria->add(ArTestCachedGroupedCdrPeer::AR_COMMUNICATION_CHANNEL_TYPE_ID, $this->ar_communication_channel_type_id);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::OPERATOR_TYPE)) $criteria->add(ArTestCachedGroupedCdrPeer::OPERATOR_TYPE, $this->operator_type);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::AR_VENDOR_ID)) $criteria->add(ArTestCachedGroupedCdrPeer::AR_VENDOR_ID, $this->ar_vendor_id);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::GEOGRAPHIC_LOCATION)) $criteria->add(ArTestCachedGroupedCdrPeer::GEOGRAPHIC_LOCATION, $this->geographic_location);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::COUNT_OF_CALLS)) $criteria->add(ArTestCachedGroupedCdrPeer::COUNT_OF_CALLS, $this->count_of_calls);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::BILLSEC)) $criteria->add(ArTestCachedGroupedCdrPeer::BILLSEC, $this->billsec);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::INCOME)) $criteria->add(ArTestCachedGroupedCdrPeer::INCOME, $this->income);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::COST_SAVING)) $criteria->add(ArTestCachedGroupedCdrPeer::COST_SAVING, $this->cost_saving);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::COST)) $criteria->add(ArTestCachedGroupedCdrPeer::COST, $this->cost);
		if ($this->isColumnModified(ArTestCachedGroupedCdrPeer::ID)) $criteria->add(ArTestCachedGroupedCdrPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArTestCachedGroupedCdrPeer::CACHED_PARENT_ID_HIERARCHY, $this->cached_parent_id_hierarchy);
		$criteria->add(ArTestCachedGroupedCdrPeer::BILLABLE_AR_ORGANIZATION_UNIT_ID, $this->billable_ar_organization_unit_id);
		$criteria->add(ArTestCachedGroupedCdrPeer::CALLDATE, $this->calldate);
		$criteria->add(ArTestCachedGroupedCdrPeer::DESTINATION_TYPE, $this->destination_type);
		$criteria->add(ArTestCachedGroupedCdrPeer::AR_COMMUNICATION_CHANNEL_TYPE_ID, $this->ar_communication_channel_type_id);
		$criteria->add(ArTestCachedGroupedCdrPeer::OPERATOR_TYPE, $this->operator_type);
		$criteria->add(ArTestCachedGroupedCdrPeer::AR_VENDOR_ID, $this->ar_vendor_id);
		$criteria->add(ArTestCachedGroupedCdrPeer::GEOGRAPHIC_LOCATION, $this->geographic_location);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArTestCachedGroupedCdr (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArTestCachedGroupedCdr Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArTestCachedGroupedCdrPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArTestCachedGroupedCdrPeer();
		}
		return self::$peer;
	}
