...
/**
 * Base static class for performing query and update operations on the 'ar_number_portability' table.
 *
 * 
 *
...
abstract class BaseArNumberPortabilityPeer {
	...
	const OM_CLASS = 'ArNumberPortability';
	 ...
	 * @param      string $column The column name for current table. (i.e. ArNumberPortabilityPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ArNumberPortabilityPeer::TABLE_NAME);
	...
	{
		return ArNumberPortabilityPeer::populateObjects(ArNumberPortabilityPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      ArNumberPortability $value A ArNumberPortability object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ArNumberPortability $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A ArNumberPortability object or a primary key value.
	 */
	 ...
	 * @return     ArNumberPortability Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to ar_number_portability
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ArNumberPortabilityPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = ArNumberPortabilityPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = ArNumberPortabilityPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				ArNumberPortabilityPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseArNumberPortabilityPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseArNumberPortabilityPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ArNumberPortabilityTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ArNumberPortabilityPeer::CLASS_DEFAULT : ArNumberPortabilityPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ArNumberPortability or Criteria object.
	 *
	 * @param      mixed $values Criteria or ArNumberPortability object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(ArNumberPortabilityPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ArNumberPortability or Criteria object.
	 *
	 * @param      mixed $values Criteria or ArNumberPortability object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the ar_number_portability table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			ArNumberPortabilityPeer::clearInstancePool();
			ArNumberPortabilityPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a ArNumberPortability or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ArNumberPortability object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ArNumberPortability) { // it's a model object
			// invalidate the cache for this single object
			ArNumberPortabilityPeer::removeInstanceFromPool($values);
	...
	/**
	 * Validates all modified columns of given ArNumberPortability object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ArNumberPortability $obj The object to validate.
	...
	public static function doValidate(ArNumberPortability $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(ArNumberPortabilityPeer::DATABASE_NAME, ArNumberPortabilityPeer::TABLE_NAME, $columns);
	}
...
} // BaseArNumberPortabilityPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseArNumberPortabilityPeer::buildTableMap();
