...
/**
 * Base class that represents a row from the 'ar_daily_status_change' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArDailyStatusChange extends BaseObject  implements Persistent {
	 ...
	 * @var        int
	 */
	protected $ar_daily_status_job_id;

	/**
	 * @var        ArDailyStatusJob
	 */
	protected $aArDailyStatusJob;
	...
	const PEER = 'ArDailyStatusChangePeer';
	 ...
	 * @return     int
	 */
	public function getArDailyStatusJobId()
	{
		return $this->ar_daily_status_job_id;
	}
	...
	public function setDay($v)
	{
		...
		if ( $this->day !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArDailyStatusChangePeer::DAY;
			}
	 ...
	 * @return     ArDailyStatusChange The current object (for fluent API support)
	 */
	public function setArDailyStatusJobId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->ar_daily_status_job_id !== $v) {
			$this->ar_daily_status_job_id = $v;
			$this->modifiedColumns[] = ArDailyStatusChangePeer::AR_DAILY_STATUS_JOB_ID;
		}

		if ($this->aArDailyStatusJob !== null && $this->aArDailyStatusJob->getId() !== $v) {
			$this->aArDailyStatusJob = null;
		}

		return $this;
	} // setArDailyStatusJobId()
	...
	public function ensureConsistency()
	{
		...
		if ($this->aArDailyStatusJob !== null && $this->ar_daily_status_job_id !== $this->aArDailyStatusJob->getId()) {
			$this->aArDailyStatusJob = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArDailyStatusChangePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArDailyStatusChangePeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArDailyStatusChangePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aArDailyStatusJob !== null) {
				if ($this->aArDailyStatusJob->isModified() || $this->aArDailyStatusJob->isNew()) {
					$affectedRows += $this->aArDailyStatusJob->save($con);
				}
				$this->setArDailyStatusJob($this->aArDailyStatusJob);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArDailyStatusChangePeer::doInsert($this, $con);
					...
					$affectedRows += ArDailyStatusChangePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aArDailyStatusJob !== null) {
				if (!$this->aArDailyStatusJob->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aArDailyStatusJob->getValidationFailures());
				}
			}


			if (($retval = ArDailyStatusChangePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArDailyStatusChangePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArDailyStatusChange (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArDailyStatusChange Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArDailyStatusChangePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArDailyStatusChangePeer();
		}
		return self::$peer;
	}

	/**
	 * Declares an association between this object and a ArDailyStatusJob object.
	 *
	 * @param      ArDailyStatusJob $v
	 * @return     ArDailyStatusChange The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setArDailyStatusJob(ArDailyStatusJob $v = null)
	{
		if ($v === null) {
			$this->setArDailyStatusJobId(NULL);
		} else {
			$this->setArDailyStatusJobId($v->getId());
		}

		$this->aArDailyStatusJob = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the ArDailyStatusJob object, it will not be re-added.
		if ($v !== null) {
			$v->addArDailyStatusChange($this);
		}
	...
	/**
	 * Get the associated ArDailyStatusJob object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     ArDailyStatusJob The associated ArDailyStatusJob object.
	 * @throws     PropelException
	 */
	public function getArDailyStatusJob(PropelPDO $con = null)
	{
		if ($this->aArDailyStatusJob === null && ($this->ar_daily_status_job_id !== null)) {
			$this->aArDailyStatusJob = ArDailyStatusJobPeer::retrieveByPk($this->ar_daily_status_job_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aArDailyStatusJob->addArDailyStatusChanges($this);
			 */
		}
		return $this->aArDailyStatusJob;
	}
