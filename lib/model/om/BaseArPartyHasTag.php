...
/**
 * Base class that represents a row from the 'ar_party_has_tag' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArPartyHasTag extends BaseObject  implements Persistent {
	 ...
	 * @return     ArPartyHasTag The current object (for fluent API support)
	 */
	public function setArPartyId($v)
	{
		...
		if ($this->ar_party_id !== $v) {
			$this->ar_party_id = $v;
			$this->modifiedColumns[] = ArPartyHasTagPeer::AR_PARTY_ID;
		}
	...
	public function setArTagId($v)
	{
		...
		if ($this->ar_tag_id !== $v) {
			$this->ar_tag_id = $v;
			$this->modifiedColumns[] = ArPartyHasTagPeer::AR_TAG_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ar_party_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->ar_tag_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = ArPartyHasTagPeer::NUM_COLUMNS - ArPartyHasTagPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArPartyHasTag object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArPartyHasTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArPartyHasTagPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArPartyHasTagPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArPartyHasTagPeer::doInsert($this, $con);
					...
					$affectedRows += ArPartyHasTagPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArPartyHasTagPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArPartyHasTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArPartyHasTagPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getArPartyId(),
			$keys[1] => $this->getArTagId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setArPartyId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setArTagId($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArPartyHasTagPeer::AR_PARTY_ID)) $criteria->add(ArPartyHasTagPeer::AR_PARTY_ID, $this->ar_party_id);
		if ($this->isColumnModified(ArPartyHasTagPeer::AR_TAG_ID)) $criteria->add(ArPartyHasTagPeer::AR_TAG_ID, $this->ar_tag_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArPartyHasTagPeer::AR_PARTY_ID, $this->ar_party_id);
		$criteria->add(ArPartyHasTagPeer::AR_TAG_ID, $this->ar_tag_id);
	...
	public function getPrimaryKey()
	{
		...
		$pks[0] = $this->getArPartyId();

		$pks[1] = $this->getArTagId();
	...
	public function setPrimaryKey($keys)
	{
		...
		$this->setArPartyId($keys[0]);

		$this->setArTagId($keys[1]);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArPartyHasTag (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArPartyHasTag Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArPartyHasTagPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArPartyHasTagPeer();
		}
		return self::$peer;
	}
	...
	public function getArParty(PropelPDO $con = null)
	{
		if ($this->aArParty === null && ($this->ar_party_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArParty->addArPartyHasTags($this);
			 */
		}
	...
	public function getArTag(PropelPDO $con = null)
	{
		if ($this->aArTag === null && ($this->ar_tag_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aArTag->addArPartyHasTags($this);
			 */
		}
		return $this->aArTag;
	}
