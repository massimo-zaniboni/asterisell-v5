...
/**
 * Base static class for performing query and update operations on the 'ar_telephone_prefix' table.
 *
 * 
 *
...
abstract class BaseArTelephonePrefixPeer {
	...
	const OM_CLASS = 'ArTelephonePrefix';
	...
	/** the column name for the MATCH_ONLY_NUMBERS_WITH_N_DIGITS field */
	const MATCH_ONLY_NUMBERS_WITH_N_DIGITS = 'ar_telephone_prefix.MATCH_ONLY_NUMBERS_WITH_N_DIGITS';
	 ...
	 * @param      string $column The column name for current table. (i.e. ArTelephonePrefixPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ArTelephonePrefixPeer::MATCH_ONLY_NUMBERS_WITH_N_DIGITS);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ArTelephonePrefixPeer::TABLE_NAME);
	...
	{
		return ArTelephonePrefixPeer::populateObjects(ArTelephonePrefixPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      ArTelephonePrefix $value A ArTelephonePrefix object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ArTelephonePrefix $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A ArTelephonePrefix object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ArTelephonePrefix) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ArTelephonePrefix object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     ArTelephonePrefix Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to ar_telephone_prefix
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = ArTelephonePrefixPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = ArTelephonePrefixPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				ArTelephonePrefixPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseArTelephonePrefixPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseArTelephonePrefixPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ArTelephonePrefixTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ArTelephonePrefixPeer::CLASS_DEFAULT : ArTelephonePrefixPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ArTelephonePrefix or Criteria object.
	 *
	 * @param      mixed $values Criteria or ArTelephonePrefix object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(ArTelephonePrefixPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from ArTelephonePrefix object
		}

		if ($criteria->containsKey(ArTelephonePrefixPeer::ID) && $criteria->keyContainsValue(ArTelephonePrefixPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ArTelephonePrefixPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ArTelephonePrefix or Criteria object.
	 *
	 * @param      mixed $values Criteria or ArTelephonePrefix object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is ArTelephonePrefix object
	...
	/**
	 * Method to DELETE all rows from the ar_telephone_prefix table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			ArTelephonePrefixPeer::clearInstancePool();
			ArTelephonePrefixPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a ArTelephonePrefix or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ArTelephonePrefix object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof ArTelephonePrefix) { // it's a model object
			// invalidate the cache for this single object
			ArTelephonePrefixPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				ArTelephonePrefixPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given ArTelephonePrefix object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ArTelephonePrefix $obj The object to validate.
	...
	public static function doValidate(ArTelephonePrefix $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(ArTelephonePrefixPeer::DATABASE_NAME, ArTelephonePrefixPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ArTelephonePrefixPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
} // BaseArTelephonePrefixPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseArTelephonePrefixPeer::buildTableMap();
