...
abstract class BaseArCdrPeer {
	...
	/** the column name for the IMPORTED_INFO field */
	const IMPORTED_INFO = 'ar_cdr.IMPORTED_INFO';

	/** the column name for the EXPORTED_INTERNAL_TELEPHONE_NUMBER field */
	const EXPORTED_INTERNAL_TELEPHONE_NUMBER = 'ar_cdr.EXPORTED_INTERNAL_TELEPHONE_NUMBER';

	/** the column name for the EXPORTED_BILLABLE_CUSTOMER_AR_PARTY_ID field */
	const EXPORTED_BILLABLE_CUSTOMER_AR_PARTY_ID = 'ar_cdr.EXPORTED_BILLABLE_CUSTOMER_AR_PARTY_ID';

	/** the column name for the FROM_SOURCE_CDR_ID field */
	const FROM_SOURCE_CDR_ID = 'ar_cdr.FROM_SOURCE_CDR_ID';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ArCdrPeer::IMPORTED_INFO);
		$criteria->addSelectColumn(ArCdrPeer::EXPORTED_INTERNAL_TELEPHONE_NUMBER);
		$criteria->addSelectColumn(ArCdrPeer::EXPORTED_BILLABLE_CUSTOMER_AR_PARTY_ID);
		$criteria->addSelectColumn(ArCdrPeer::FROM_SOURCE_CDR_ID);
	}
