...
/**
 * Base class that represents a row from the 'ar_wholesale_replace_proc' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArWholesaleReplaceProc extends BaseObject  implements Persistent {
	 ...
	 * @var        ArWholesaleReplaceProcPeer
	 */
	...
	const PEER = 'ArWholesaleReplaceProcPeer';
	 ...
	 * @return     ArWholesaleReplaceProc The current object (for fluent API support)
	 */
	public function setFromDate($v)
	{
		...
		if ( $this->from_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArWholesaleReplaceProcPeer::FROM_DATE;
			}
	...
	public function setArResellerId($v)
	{
		...
		if ($this->ar_reseller_id !== $v) {
			...
			$this->modifiedColumns[] = ArWholesaleReplaceProcPeer::AR_RESELLER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ArWholesaleReplaceProcPeer::NUM_COLUMNS - ArWholesaleReplaceProcPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArWholesaleReplaceProc object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArWholesaleReplaceProcPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArWholesaleReplaceProcPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArWholesaleReplaceProcPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArWholesaleReplaceProcPeer::doInsert($this, $con);
					...
					$affectedRows += ArWholesaleReplaceProcPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArWholesaleReplaceProcPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArWholesaleReplaceProcPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArWholesaleReplaceProcPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArWholesaleReplaceProcPeer::FROM_DATE)) $criteria->add(ArWholesaleReplaceProcPeer::FROM_DATE, $this->from_date);
		if ($this->isColumnModified(ArWholesaleReplaceProcPeer::AR_RESELLER_ID)) $criteria->add(ArWholesaleReplaceProcPeer::AR_RESELLER_ID, $this->ar_reseller_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArWholesaleReplaceProcPeer::FROM_DATE, $this->from_date);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArWholesaleReplaceProc (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArWholesaleReplaceProc Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArWholesaleReplaceProcPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArWholesaleReplaceProcPeer();
		}
		return self::$peer;
	}
	...
	public function setArReseller(ArReseller $v = null)
	{
		...
		if ($v !== null) {
			$v->addArWholesaleReplaceProc($this);
		}
	...
	public function getArReseller(PropelPDO $con = null)
	{
		if ($this->aArReseller === null && ($this->ar_reseller_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArReseller->addArWholesaleReplaceProcs($this);
			 */
		}
