...
/**
 * Base class that represents a row from the 'ar_report_generation' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArReportGeneration extends BaseObject  implements Persistent {
	...
	const PEER = 'ArReportGenerationPeer';
	 ...
	 * @return     ArReportGeneration The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArReportGenerationPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ArReportGenerationPeer::NAME;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = ArReportGenerationPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ArReportGenerationPeer::NUM_COLUMNS - ArReportGenerationPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArReportGeneration object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArReportGenerationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArReportGenerationPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArReportGenerationPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArReportGenerationPeer::doInsert($this, $con);
					...
					$affectedRows += ArReportGenerationPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArReportGenerationPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArReportGenerationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArReportGenerationPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArReportGenerationPeer::ID)) $criteria->add(ArReportGenerationPeer::ID, $this->id);
		if ($this->isColumnModified(ArReportGenerationPeer::NAME)) $criteria->add(ArReportGenerationPeer::NAME, $this->name);
		if ($this->isColumnModified(ArReportGenerationPeer::DESCRIPTION)) $criteria->add(ArReportGenerationPeer::DESCRIPTION, $this->description);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArReportGenerationPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArReportGeneration (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArReportGeneration Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArReportGenerationPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArReportGenerationPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ArReportGeneration has previously been saved, it will retrieve
	 * related ArReportSchedulers from storage. If this ArReportGeneration is new, it will return
		...
		if ($this->collArReportSchedulers === null) {
			if ($this->isNew()) {
			   $this->collArReportSchedulers = array();
				...
				$criteria->add(ArReportSchedulerPeer::AR_REPORT_GENERATION_ID, $this->id);
	 ...
	 * Otherwise if this ArReportGeneration is new, it will return
	 * an empty collection; or if this ArReportGeneration has previously
	 * been saved, it will retrieve related ArReportSchedulers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ArReportGeneration.
	 */
