...
/**
 * Base class that represents a row from the 'ar_rate_shared_with_reseller' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArRateSharedWithReseller extends BaseObject  implements Persistent {
	 ...
	 * @var        ArRateSharedWithResellerPeer
	 */
	...
	/**
	 * The value for the is_exported field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_exported;
	...
	const PEER = 'ArRateSharedWithResellerPeer';
	...
	/**
	 * Initializes internal state of BaseArRateSharedWithReseller object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [is_exported] column value.
	 * 
	 * @return     boolean
	 */
	 ...
	 * @return     ArRateSharedWithReseller The current object (for fluent API support)
	 */
	public function setArRateId($v)
	{
		...
		if ($this->ar_rate_id !== $v) {
			$this->ar_rate_id = $v;
			$this->modifiedColumns[] = ArRateSharedWithResellerPeer::AR_RATE_ID;
		}
	...
	public function setArResellerId($v)
	{
		...
		if ($this->ar_reseller_id !== $v) {
			...
			$this->modifiedColumns[] = ArRateSharedWithResellerPeer::AR_RESELLER_ID;
		}
	...
	/**
	 * Set the value of [is_exported] column.
	 * 
	...
	public function setIsExported($v)
	{
		...
		if ($this->is_exported !== $v || $this->isNew()) {
			$this->is_exported = $v;
			$this->modifiedColumns[] = ArRateSharedWithResellerPeer::IS_EXPORTED;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArRateSharedWithResellerPeer::ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ar_rate_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->ar_reseller_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->is_exported = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = ArRateSharedWithResellerPeer::NUM_COLUMNS - ArRateSharedWithResellerPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArRateSharedWithReseller object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArRateSharedWithResellerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArRateSharedWithResellerPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArRateSharedWithResellerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArRateSharedWithResellerPeer::doInsert($this, $con);
					...
					$affectedRows += ArRateSharedWithResellerPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArRateSharedWithResellerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArRateSharedWithResellerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArRateSharedWithResellerPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getArRateId(),
			$keys[1] => $this->getArResellerId(),
			$keys[2] => $this->getIsExported(),
			$keys[3] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setArRateId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setArResellerId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setIsExported($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArRateSharedWithResellerPeer::AR_RATE_ID)) $criteria->add(ArRateSharedWithResellerPeer::AR_RATE_ID, $this->ar_rate_id);
		if ($this->isColumnModified(ArRateSharedWithResellerPeer::AR_RESELLER_ID)) $criteria->add(ArRateSharedWithResellerPeer::AR_RESELLER_ID, $this->ar_reseller_id);
		if ($this->isColumnModified(ArRateSharedWithResellerPeer::IS_EXPORTED)) $criteria->add(ArRateSharedWithResellerPeer::IS_EXPORTED, $this->is_exported);
		if ($this->isColumnModified(ArRateSharedWithResellerPeer::ID)) $criteria->add(ArRateSharedWithResellerPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArRateSharedWithResellerPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArRateSharedWithReseller (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArRateSharedWithReseller Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArRateSharedWithResellerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArRateSharedWithResellerPeer();
		}
		return self::$peer;
	}
	...
	public function setArRate(ArRate $v = null)
	{
		...
		if ($v !== null) {
			$v->addArRateSharedWithReseller($this);
		}
	...
	public function getArRate(PropelPDO $con = null)
	{
		if ($this->aArRate === null && ($this->ar_rate_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArRate->addArRateSharedWithResellers($this);
			 */
		}
		return $this->aArRate;
	}
	...
	public function getArReseller(PropelPDO $con = null)
	{
		if ($this->aArReseller === null && ($this->ar_reseller_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aArReseller->addArRateSharedWithResellers($this);
			 */
		}
