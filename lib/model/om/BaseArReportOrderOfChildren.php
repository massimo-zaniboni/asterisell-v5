...
/**
 * Base class that represents a row from the 'ar_report_order_of_children' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArReportOrderOfChildren extends BaseObject  implements Persistent {
	 ...
	 * @var        ArReportOrderOfChildrenPeer
	 */
	...
	const PEER = 'ArReportOrderOfChildrenPeer';
	 ...
	 * @return     ArReportOrderOfChildren The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArReportOrderOfChildrenPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ArReportOrderOfChildrenPeer::NAME;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = ArReportOrderOfChildrenPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ArReportOrderOfChildrenPeer::NUM_COLUMNS - ArReportOrderOfChildrenPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArReportOrderOfChildren object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArReportOrderOfChildrenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArReportOrderOfChildrenPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArReportOrderOfChildrenPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArReportOrderOfChildrenPeer::doInsert($this, $con);
					...
					$affectedRows += ArReportOrderOfChildrenPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArReportOrderOfChildrenPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArReportOrderOfChildrenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArReportOrderOfChildrenPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArReportOrderOfChildrenPeer::ID)) $criteria->add(ArReportOrderOfChildrenPeer::ID, $this->id);
		if ($this->isColumnModified(ArReportOrderOfChildrenPeer::NAME)) $criteria->add(ArReportOrderOfChildrenPeer::NAME, $this->name);
		if ($this->isColumnModified(ArReportOrderOfChildrenPeer::DESCRIPTION)) $criteria->add(ArReportOrderOfChildrenPeer::DESCRIPTION, $this->description);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArReportOrderOfChildrenPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArReportOrderOfChildren (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArReportOrderOfChildren Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArReportOrderOfChildrenPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArReportOrderOfChildrenPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ArReportOrderOfChildren has previously been saved, it will retrieve
	 * related ArReports from storage. If this ArReportOrderOfChildren is new, it will return
	...
	public function addArReport(ArReport $l)
	{
		...
		if (!in_array($l, $this->collArReports, true)) { // only add it if the **same** object is not already associated
			...
			$l->setArReportOrderOfChildren($this);
		}
	}
