...
/**
 * Base class that represents a row from the 'ar_postponed_report' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArPostponedReport extends BaseObject  implements Persistent {
	...
	const PEER = 'ArPostponedReportPeer';
	 ...
	 * @return     ArPostponedReport The current object (for fluent API support)
	 */
	public function setArReportSetId($v)
	{
		...
		if ($this->ar_report_set_id !== $v) {
			...
			$this->modifiedColumns[] = ArPostponedReportPeer::AR_REPORT_SET_ID;
		}
	...
	public function setArOrganizationUnitId($v)
	{
		...
		if ($this->ar_organization_unit_id !== $v) {
			...
			$this->modifiedColumns[] = ArPostponedReportPeer::AR_ORGANIZATION_UNIT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ar_report_set_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = ArPostponedReportPeer::NUM_COLUMNS - ArPostponedReportPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArPostponedReport object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArPostponedReportPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArPostponedReportPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArPostponedReportPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArPostponedReportPeer::doInsert($this, $con);
					...
					$affectedRows += ArPostponedReportPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArPostponedReportPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArPostponedReportPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArPostponedReportPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getArReportSetId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setArReportSetId($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArPostponedReportPeer::AR_REPORT_SET_ID)) $criteria->add(ArPostponedReportPeer::AR_REPORT_SET_ID, $this->ar_report_set_id);
		if ($this->isColumnModified(ArPostponedReportPeer::AR_ORGANIZATION_UNIT_ID)) $criteria->add(ArPostponedReportPeer::AR_ORGANIZATION_UNIT_ID, $this->ar_organization_unit_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArPostponedReportPeer::AR_REPORT_SET_ID, $this->ar_report_set_id);
		$criteria->add(ArPostponedReportPeer::AR_ORGANIZATION_UNIT_ID, $this->ar_organization_unit_id);
	...
	public function getPrimaryKey()
	{
		...
		$pks[0] = $this->getArReportSetId();

		$pks[1] = $this->getArOrganizationUnitId();
	...
	public function setPrimaryKey($keys)
	{
		...
		$this->setArReportSetId($keys[0]);

		$this->setArOrganizationUnitId($keys[1]);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArPostponedReport (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArPostponedReport Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArPostponedReportPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArPostponedReportPeer();
		}
		return self::$peer;
	}
	...
	public function getArReportSet(PropelPDO $con = null)
	{
		if ($this->aArReportSet === null && ($this->ar_report_set_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArReportSet->addArPostponedReports($this);
			 */
		}
	...
	public function getArOrganizationUnit(PropelPDO $con = null)
	{
		if ($this->aArOrganizationUnit === null && ($this->ar_organization_unit_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aArOrganizationUnit->addArPostponedReports($this);
			 */
		}
