...
/**
 * Base class that represents a row from the 'ar_database_version' table.
 *
 * 
 *
...
abstract class BaseArDatabaseVersion extends BaseObject  implements Persistent {
	...
	const PEER = 'ArDatabaseVersionPeer';
	 ...
	 * @return     ArDatabaseVersion The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ArDatabaseVersionPeer::NUM_COLUMNS - ArDatabaseVersionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArDatabaseVersionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArDatabaseVersionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArDatabaseVersion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArDatabaseVersion Clone of current object.
	 * @throws     PropelException
	 */
