...
/**
 * Base class that represents a row from the 'ar_cached_errors' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArCachedErrors extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseArCachedErrors object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ArCachedErrors The current object (for fluent API support)
	 */
	public function setCalldate($v)
	{
		...
		if ( $this->calldate !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArCachedErrorsPeer::CALLDATE;
			}
	...
	public function setDestinationType($v)
	{
		...
		if ($this->destination_type !== $v) {
			...
			$this->modifiedColumns[] = ArCachedErrorsPeer::DESTINATION_TYPE;
		}
	...
	public function setErrorDestinationType($v)
	{
		...
		if ($this->error_destination_type !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = ArCachedErrorsPeer::ERROR_DESTINATION_TYPE;
		}
	...
	public function setCountOfCalls($v)
	{
		...
		if ($this->count_of_calls !== $v) {
			...
			$this->modifiedColumns[] = ArCachedErrorsPeer::COUNT_OF_CALLS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ArCachedErrorsPeer::NUM_COLUMNS - ArCachedErrorsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArCachedErrors object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArCachedErrorsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArCachedErrorsPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArCachedErrorsPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArCachedErrorsPeer::doInsert($this, $con);
					...
					$affectedRows += ArCachedErrorsPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArCachedErrorsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArCachedErrorsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArCachedErrorsPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArCachedErrorsPeer::CALLDATE)) $criteria->add(ArCachedErrorsPeer::CALLDATE, $this->calldate);
		if ($this->isColumnModified(ArCachedErrorsPeer::DESTINATION_TYPE)) $criteria->add(ArCachedErrorsPeer::DESTINATION_TYPE, $this->destination_type);
		if ($this->isColumnModified(ArCachedErrorsPeer::ERROR_DESTINATION_TYPE)) $criteria->add(ArCachedErrorsPeer::ERROR_DESTINATION_TYPE, $this->error_destination_type);
		if ($this->isColumnModified(ArCachedErrorsPeer::COUNT_OF_CALLS)) $criteria->add(ArCachedErrorsPeer::COUNT_OF_CALLS, $this->count_of_calls);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArCachedErrorsPeer::CALLDATE, $this->calldate);
		$criteria->add(ArCachedErrorsPeer::DESTINATION_TYPE, $this->destination_type);
		$criteria->add(ArCachedErrorsPeer::ERROR_DESTINATION_TYPE, $this->error_destination_type);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArCachedErrors (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArCachedErrors Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArCachedErrorsPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArCachedErrorsPeer();
		}
		return self::$peer;
	}
