...
/**
 * Base class that represents a row from the 'ar_service_price' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArServicePrice extends BaseObject  implements Persistent {
	 ...
	 * @return     ArServicePrice The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArServicePricePeer::ID;
		}
	...
	public function setInternalName($v)
	{
		...
		if ($this->internal_name !== $v) {
			...
			$this->modifiedColumns[] = ArServicePricePeer::INTERNAL_NAME;
		}
	...
	public function setArServiceId($v)
	{
		...
		if ($this->ar_service_id !== $v) {
			...
			$this->modifiedColumns[] = ArServicePricePeer::AR_SERVICE_ID;
		}
	...
	public function setFromDate($v)
	{
		...
		if ( $this->from_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArServicePricePeer::FROM_DATE;
			}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = ArServicePricePeer::PRICE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ar_service_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = ArServicePricePeer::NUM_COLUMNS - ArServicePricePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArServicePrice object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArServicePricePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArServicePricePeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArServicePricePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArServicePricePeer::doInsert($this, $con);
					...
					$affectedRows += ArServicePricePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArServicePricePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArServicePricePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArServicePricePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getInternalName(),
			$keys[2] => $this->getArServiceId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setArServiceId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArServicePricePeer::ID)) $criteria->add(ArServicePricePeer::ID, $this->id);
		if ($this->isColumnModified(ArServicePricePeer::INTERNAL_NAME)) $criteria->add(ArServicePricePeer::INTERNAL_NAME, $this->internal_name);
		if ($this->isColumnModified(ArServicePricePeer::AR_SERVICE_ID)) $criteria->add(ArServicePricePeer::AR_SERVICE_ID, $this->ar_service_id);
		if ($this->isColumnModified(ArServicePricePeer::FROM_DATE)) $criteria->add(ArServicePricePeer::FROM_DATE, $this->from_date);
		if ($this->isColumnModified(ArServicePricePeer::PRICE)) $criteria->add(ArServicePricePeer::PRICE, $this->price);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArServicePricePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArServicePrice (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArServicePrice Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArServicePricePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArServicePricePeer();
		}
		return self::$peer;
	}
	...
	public function getArService(PropelPDO $con = null)
	{
		if ($this->aArService === null && ($this->ar_service_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArService->addArServicePrices($this);
			 */
		}
