...
/**
 * Base class that represents a row from the 'ar_custom_rate_form' table.
 *
 * 
 *
...
abstract class BaseArCustomRateForm extends BaseObject  implements Persistent {
	...
	const PEER = 'ArCustomRateFormPeer';
	 ...
	 * @return     ArCustomRateForm The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = ArCustomRateFormPeer::NUM_COLUMNS - ArCustomRateFormPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aArRate !== null && $this->id !== $this->aArRate->getId()) {
			$this->aArRate = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArCustomRateFormPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArCustomRateFormPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArCustomRateForm (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArCustomRateForm Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getArRate(PropelPDO $con = null)
	{
		if ($this->aArRate === null && ($this->id !== null)) {
			$this->aArRate = ArRatePeer::retrieveByPk($this->id);
			// Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
			$this->aArRate->setArCustomRateForm($this);
		}
		return $this->aArRate;
	}
