...
/**
 * Base class that represents a row from the 'ar_wholesale_carrier' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseArWholesaleCarrier extends BaseObject  implements Persistent {
	...
	const PEER = 'ArWholesaleCarrierPeer';
	 ...
	 * @return     ArWholesaleCarrier The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ArWholesaleCarrierPeer::ID;
		}
	...
	public function setInternalName($v)
	{
		...
		if ($this->internal_name !== $v) {
			...
			$this->modifiedColumns[] = ArWholesaleCarrierPeer::INTERNAL_NAME;
		}
	...
	public function setNote($v)
	{
		...
		if ($this->note !== $v) {
			$this->note = $v;
			$this->modifiedColumns[] = ArWholesaleCarrierPeer::NOTE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ArWholesaleCarrierPeer::NUM_COLUMNS - ArWholesaleCarrierPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArWholesaleCarrier object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArWholesaleCarrierPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ArWholesaleCarrierPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArWholesaleCarrierPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArWholesaleCarrierPeer::doInsert($this, $con);
					...
					$affectedRows += ArWholesaleCarrierPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArWholesaleCarrierPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArWholesaleCarrierPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArWholesaleCarrierPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArWholesaleCarrierPeer::ID)) $criteria->add(ArWholesaleCarrierPeer::ID, $this->id);
		if ($this->isColumnModified(ArWholesaleCarrierPeer::INTERNAL_NAME)) $criteria->add(ArWholesaleCarrierPeer::INTERNAL_NAME, $this->internal_name);
		if ($this->isColumnModified(ArWholesaleCarrierPeer::NOTE)) $criteria->add(ArWholesaleCarrierPeer::NOTE, $this->note);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArWholesaleCarrierPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ArWholesaleCarrier (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ArWholesaleCarrier Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArWholesaleCarrierPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArWholesaleCarrierPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ArWholesaleCarrier has previously been saved, it will retrieve
	 * related ArWholesaleNumbers from storage. If this ArWholesaleCarrier is new, it will return
		...
		if ($this->collArWholesaleNumbers === null) {
			if ($this->isNew()) {
			   $this->collArWholesaleNumbers = array();
				...
				$criteria->add(ArWholesaleNumberPeer::AR_WHOLESALE_CARRIER_ID, $this->id);
	 ...
	 * Otherwise if this ArWholesaleCarrier is new, it will return
	 * an empty collection; or if this ArWholesaleCarrier has previously
	 * been saved, it will retrieve related ArWholesaleNumbers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ArWholesaleCarrier.
	 */
	public function getArWholesaleNumbersJoinArReseller($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArWholesaleCarrierPeer::DATABASE_NAME);
		}
		...
		if ($this->collArWholesaleNumbers === null) {
			if ($this->isNew()) {
				...
				$this->collArWholesaleNumbers = ArWholesaleNumberPeer::doSelectJoinArReseller($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
