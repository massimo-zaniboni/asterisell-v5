...
$options = OrganizationUnitInfo::getInstance()->getUIOrganizationSelector($selectedOrganizationId, false, true, false, true, ! $user->isAdmin());
...
echo select_tag('filters[filter_on_voip_account]', options_for_select($options, $defaultChoice));
