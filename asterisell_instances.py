...
import os.path
import datetime
from fabric_data.lib import Domain, SelfSignedDomain, LetsEncryptDomain, Host, Instance, BillingInstance, CallReportingInstance, ConnectionParams
...
class DefaultInstance(BillingInstance):
    ...
    def conf_connection_params(self):
      ...
      #   c.port = '8001'
      #   c.dbName = ''               # NOTE: optional params supported only from some jobs
      #   c.tableName = ''            # NOTE: optional params supported only from some jobs
      #   c.provider = ''             # NOTE: optional params supported only from some jobs
      #   c.timeFrameInMinutes = '0'  # NOTE: optional params supported only from some jobs
      #   c.dataSourceFormat = ''     # NOTE: optional params supported only from some jobs
      #   c.dataSourceVersion = ''    # NOTE: optional params supported only from some jobs
      #   r.append(c)

      # NOTE: The default job `ImportCustomersDataAskingToRatingEngine`
      #       process all params with name prefix "import-remote-cdrs-".

      # NOTE: The default job `ImportCDRSUsingAppConfs`
      #       process all params with name prefix "import-remote-cdrs-".
