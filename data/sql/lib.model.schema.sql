...
DROP TABLE IF EXISTS `ar_wholesale_carrier`;
...
DROP TABLE IF EXISTS `ar_wholesale_number`;
...
DROP TABLE IF EXISTS `ar_wholesale_number_transaction`;
...
DROP TABLE IF EXISTS `ar_wholesale_number_imported_date_proc`;
...
DROP TABLE IF EXISTS `ar_wholesale_number_transaction_to_update`;
...
DROP TABLE IF EXISTS `ar_wholesale_update_proc`;
...
DROP TABLE IF EXISTS `ar_wholesale_replace_proc`;
