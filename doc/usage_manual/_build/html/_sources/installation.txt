...
For installations directly on host systems, you must contact the assistance_.
...
These values are for each instance.
...
.. warning::
   Asterisell is stable and used in production, but installed on virtual machines,
   while Docker support is new. So there can be temporary problems.
   In case feel free to contact assistance_, so they will be fixed.
